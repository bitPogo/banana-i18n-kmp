...
internal class DefaultArgumentsParser private constructor(
    ...
    private fun argument(tokenizer: PublicApi.ParserEngine): PublicApi.Node {
    ...
    override fun parse(tokenizer: PublicApi.ParserEngine): PublicApi.Node = argument(tokenizer)
